<template>
    <div>
        <div class="card">
            ...
            <div class="card-body">
                <div v-if="ifReady">
                    <form method="POST" accept-charset="utf-8" v-on:submit.prevent="createNewPermission">
                        <div class="row">
                        ...
                        <button type="submit" class="btn btn-success btn-sm">Create New Permission</button>
                    </form>
                </div>
...
export default {
    ...
    methods: {
        createNewPermission() {
            ...
            axios.post('/api/permissions', this.$data).then(res => {
