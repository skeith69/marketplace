...
<script>
const getAdmins = (page, per_page, callback) => {
...
export default {
    ...
    beforeRouteEnter (to, from, next) {
        if (to.query.per_page == null) {
            getAdmins(to.query.page, 10, (err, data) => {
                next(vm => vm.setData(err, data));
            });
        } else {
            getAdmins(to.query.page, to.query.per_page, (err, data) => {
                next(vm => vm.setData(err, data));
            });
        }
    },
    ...
    beforeRouteUpdate (to, from, next) {
        getAdmins(to.query.page, this.meta.per_page, (err, data) => {
